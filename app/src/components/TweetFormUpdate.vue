...
const update = async () => {
    ...
    const updatedTweet = await updateTweet(tweet.value.key, slugTopic.value, content.value)
    emit('updated', updatedTweet)
}
</script>
    ...
    <div v-if="connected">
        <div class="px-8 py-4 border-l-4 border-pink-500">
            <div class="py-1">
                ...
                <time class="text-gray-500 text-sm" :title="tweet.createdAt">
